...
The [Business Text visualization panel](https://grafana.com/docs/plugins/marcusolsson-dynamictext-panel/<PLUGINS_VERSION>/) is a perfect companion to Business News Data Source.
